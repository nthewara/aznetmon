...
GOOS=linux GOARCH=amd64 go build -o aznetmon-linux main.go
...
# Or manually:
GOOS=windows GOARCH=amd64 go build -o aznetmon.exe main.go
GOOS=darwin GOARCH=amd64 go build -o aznetmon-mac main.go
GOOS=linux GOARCH=amd64 go build -o aznetmon-linux main.go
```
...
[⬆ Back to Top](#-aznetmon---lightning-fast-icmp-network-monitor)
